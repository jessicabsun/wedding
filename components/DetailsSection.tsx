          ...
          <div className={styles.cardInner}>
            ...
            <div className={styles.dayBlock}>
              ...
              <div className={styles.item}>
                <span className={styles.venueName}>Ceremony</span>
                <span className={styles.venueDetail}>
                  Private ceremony &middot; Immediate family only
                </span>
              </div>
              ...
              <div className={styles.item}>
                ...
                <span className={styles.venueDetail}>Transportation from dinner available</span>
              </div>
